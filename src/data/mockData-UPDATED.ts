...
import hommeImg from '../assets/categories/homme.png';
...
import homme1 from '../assets/products/mode-homme/homme1.png';
import homme2 from '../assets/products/mode-homme/homme2.png';
import homme3 from '../assets/products/mode-homme/homme3.png';
import homme4 from '../assets/products/mode-homme/homme4.png';
import homme5 from '../assets/products/mode-homme/homme5.png';
import homme6 from '../assets/products/mode-homme/homme6.png';

// Imports des images locales pour les produits - Maison & Déco
import maison1 from '../assets/products/mode-maison/maison1.jpg';
import maison2 from '../assets/products/mode-maison/maison2.jpg';
import maison3 from '../assets/products/mode-maison/maison3.jpg';
import maison4 from '../assets/products/mode-maison/maison4.jpg';

// Imports des images locales pour les produits - Sport & Fitness
import sport1 from '../assets/products/mode-sport/sport1.jpeg';
import sport2 from '../assets/products/mode-sport/sport2.jpeg';
import sport3 from '../assets/products/mode-sport/sport3.jpg';
import sport4 from '../assets/products/mode-sport/sport6.jpg';
...
export const getDiscountedProducts = (limit: number = 8): Product[] => {
  return mockProducts
    .filter(p => p.discount !== undefined && p.discount !== null && p.discount > 0)
...
export const getReviewsByProductId = (productId: string, limit: number = 10) => {
  // Mock reviews - dans une vraie application, ceci viendrait d'une API
  const mockReviews = [
    {
      id: '1',
      userId: 'user1',
    ...
    },
    {
      ...
      rating: 4,
      comment: 'Conforme à la description, livraison rapide',
      createdAt: new Date('2026-01-08')
    }
  ];
